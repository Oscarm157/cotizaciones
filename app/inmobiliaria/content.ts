...
export const PRICE_COTIZADOR: number | null = 1700;
...
export const CONTENT = {
  ...
  before: {
    ...
    items: [
      ...
      "La trayectoria del grupo no llega a los prospectos por un canal digital propio.",
    ...
    items: [
      {
        ...
        detail:
          "Funciona correctamente en computadoras y dispositivos móviles. Refleja la seriedad de una operación inmobiliaria profesional.",
      },
      {
        icon: "filter_alt",
