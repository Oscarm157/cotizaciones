...
/**
 * Version animada de ChatMock: revela los mensajes uno a uno, muestra
 ...
 * muestra toda la conversacion estatica. Solo pantalla (en PDF va el ChatMock estatico).
 */
export function ChatMockLive({ t }: { t: (typeof CONTENT)[Lang] }) {
  const messages = t.chat;
  const ui = t.chatHeader;
  ...
  return (
    <div
      className="rounded-xl border border-card-border bg-card overflow-hidden flex flex-col shadow-sm glow-accent-subtle"
    ...
    >
      ...
      <div
        ref={scrollRef}
        className="h-[260px] sm:h-[280px] overflow-y-auto scrollbar-hide p-3 flex flex-col justify-end gap-2"
      >
